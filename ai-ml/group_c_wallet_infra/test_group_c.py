...
"""
    ...
    def test_wallet_cluster(self):
        ...
        # lookup_risk
        label = lookup_risk("1BvBMSEYstWetqTFn5Au4m4GFg7xJaNVN2", csv_path=self.csv_path)
        self.assertEqual(label, "princetonCerber")
        label_safe = lookup_risk("1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa", csv_path=self.csv_path)
